            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table card-table table-striped table-vcenter">
                        ...
                        <tr>
                            <td><span class="avatar" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/faces/female/1.jpg)"></span></td>
                        ...
                        <tr>
                            <td><span class="avatar" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/faces/male/4.jpg)"></span></td>
                            <td>Bobby Knight</td>
                        ...
                        <tr>
                            <td><span class="avatar" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/faces/female/11.jpg)"></span></td>
                            <td>Sharon Wells</td>
                            <td>Fixes #625</td>
    ...
    <div class="row row-cards row-deck">
        <div class="col-lg-6">
            <div class="card card-aside">
                <a href="#" class="card-aside-column" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/photos/david-klaasen-54203-500.jpg)"></a>
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center pt-5 mt-auto">
                        <div class="avatar avatar-md mr-3" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/faces/female/18.jpg)"></div>
                        <div>
        ...
        <div class="col-lg-6">
            <div class="card card-aside">
                <a href="#" class="card-aside-column" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/photos/david-marcu-114194-500.jpg)"></a>
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center pt-5 mt-auto">
                        <div class="avatar avatar-md mr-3" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/faces/male/16.jpg)"></div>
                        <div>
            ...
            <div class="card">
                <div class="table-responsive">
                    <table class="table table-hover table-outline table-vcenter text-nowrap card-table">
                        ...
                        <tr>
                            <td class="text-center">
                                <div class="avatar d-block" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/faces/female/17.jpg)">
                                    <span class="avatar-status bg-green"></span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="text-center">
                                <div class="avatar d-block" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/faces/female/21.jpg)">
                                    <span class="avatar-status bg-green"></span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="text-center">
                                <div class="avatar d-block" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/faces/male/32.jpg)">
                                    <span class="avatar-status bg-green"></span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="text-center">
                                <div class="avatar d-block" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/faces/female/12.jpg)">
                                    <span class="avatar-status bg-green"></span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="text-center">
                                <div class="avatar d-block" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/faces/female/4.jpg)">
                                    <span class="avatar-status bg-green"></span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="text-center">
                                <div class="avatar d-block" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/faces/female/27.jpg)">
                                    <span class="avatar-status bg-green"></span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="text-center">
                                <div class="avatar d-block" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/faces/male/20.jpg)">
                                    <span class="avatar-status bg-green"></span>
                                </div>
                            </td>
                            <td>
                    ...
                    <ul class="list-unstyled list-separated">
                        <li class="list-separated-item">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <span class="avatar avatar-md d-block" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/faces/female/12.jpg)"></span>
                                </div>
                                <div class="col">
                                    <div>
                        ...
                        <li class="list-separated-item">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <span class="avatar avatar-md d-block" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/faces/female/21.jpg)"></span>
                                </div>
                                <div class="col">
                                    <div>
                        ...
                        <li class="list-separated-item">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <span class="avatar avatar-md d-block" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/faces/female/29.jpg)"></span>
                                </div>
                                <div class="col">
                                    <div>
                        ...
                        <li class="list-separated-item">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <span class="avatar avatar-md d-block" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/faces/female/2.jpg)"></span>
                                </div>
                                <div class="col">
                                    <div>
                        ...
                        <li class="list-separated-item">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <span class="avatar avatar-md d-block" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/faces/male/34.jpg)"></span>
                                </div>
                                <div class="col">
                                    <div>
                        ...
                        <li class="list-separated-item">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <span class="avatar avatar-md d-block" style="background-image: url(/assets/themes/phlexus-tabler-admin/demo/faces/female/11.jpg)"></span>
                                </div>
                                <div class="col">
                                    <div>
